...
def create_glass_material(glass_obj, img_T, img_h, img_mark, img_height, recipe, bump_distance):
    ...
    # This is a tracked material channel now, not throwaway procedural noise.
