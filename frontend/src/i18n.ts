...
const resources = {
  en: {
    translation: {
      ...
      tutorialStep3Title: "Drag a box around a piece",
      tutorialStep3Body: "Drag a box around one of the panes. Vitrai's segmentation model traces the exact shape. You'll repeat this for every piece in your pattern.",
  ...
  fr: {
    translation: {
      ...
      tutorialStep3Title: "Tracez une boîte autour d'une pièce",
      tutorialStep3Body: "Tracez une boîte autour d'une des pièces. Le modèle de segmentation trace la forme exacte. Répétez pour chaque pièce du patron.",
