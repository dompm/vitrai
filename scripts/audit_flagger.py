...
VENDORED COPY -- provenance: research/delighting branch `research/delighting-019` (last
touched on trunk at commit 77d9c81b2cddb19db5ead661976afd245f3de767), path
`research/delighting/corpus/audit_flagger.py`, unmodified except for this header.
Vendored (iteration 036) as `swatch_picker.py`'s component-(a) dependency, so
`feat/library-picker-rebuild` has no path dependency on the research worktree. Re-copy
from the research/delighting trunk to pick up upstream fixes.
